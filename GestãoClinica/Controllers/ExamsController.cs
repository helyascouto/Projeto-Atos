...
namespace GestãoClinica.Controllers
{
    public class ExamsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("NameExams,Id,Ativo,DateRegister")] Exams exams)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NameExams,Id,Ativo,DateRegister")] Exams exams)
        {
            if (id != exams.Id)
            {
                return NotFound();
