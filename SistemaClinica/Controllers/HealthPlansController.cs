...
namespace SistemaClinica.Controllers
{
    ...
    public class HealthPlansController : Controller
    {
        ...
        public HealthPlansController(ContextoSql context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("NameCompany,CNPJ,Telephone,Email,ZipCod,Number,District,City,State,Id")] HealthPlanModel healthPlanModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("NameCompany,CNPJ,Telephone,Email,ZipCod,Number,District,City,State,Id")] HealthPlanModel healthPlanModel)
        {
