...
namespace SistemaClinica.Controllers
{
    ...
    public class AddressesController : Controller
    {
        ...
        public AddressesController(ContextoSql context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Telephone,Email,ZipCod,Number,District,City,State,Id")] AddressModel addressModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Telephone,Email,ZipCod,Number,District,City,State,Id")] AddressModel addressModel)
        {
