...
namespace SistemaClinica.Controllers
{
    ...
    public class DoctorsController : Controller
    {
        ...
        public DoctorsController(ContextoSql context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("CRM,CPF,FistName,LastName,DateBirth,Telephone,Email,ZipCod,Number,District,City,State,Id")] DoctorModel doctorModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CRM,CPF,FistName,LastName,DateBirth,Telephone,Email,ZipCod,Number,District,City,State,Id")] DoctorModel doctorModel)
        {
